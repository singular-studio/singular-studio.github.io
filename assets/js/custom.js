$(function() {
  ...
  $( window ).on("scroll", function(e) {
    this.scrollTop > windowHeight - 100 ? firstItem(this) : idea.removeClass("visible");

    function firstItem(object) {
      idea.addClass("visible");
      object.scrollTop > windowHeight ? fixList(object) : methodContainer.removeClass("fixed");
    }

    function fixList(object) {
      methodContainer.addClass("fixed");
      object.scrollTop > windowHeight + 300 ? secondItem(object) : discussion.removeClass("visible");
    }

    function secondItem(object) {
      discussion.addClass("visible");
      object.scrollTop > windowHeight + 600 ? thirdItem(object) : mockup.removeClass("visible");
    }

    function thirdItem(object) {
      mockup.addClass("visible");
      object.scrollTop > windowHeight + 900 ? fourthItem(object) : website.removeClass("visible");
    }
